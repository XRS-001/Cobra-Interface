...
class S256Point(Point):
    ...
    def address(self, compressed=True, testnet=False, segwit=False):
        ...
        if not segwit:
            ...
            return bech32_address("bc", 0, h160)
...
def decode_bech32(hrp: str, addr: str) -> Union[Tuple[None, None], Tuple[int, bytes]]:
