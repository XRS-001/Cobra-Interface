...
from Bitcoin.tx import read_varint, little_endian_to_int, int_to_little_endian, encode_varint
from Bitcoin.ecc import encode_base58_checksum
from hashlib import sha256
from io import BytesIO
from Bitcoin.op import op_hash160, op_equal, op_verify
...
class Script:
    ...
    def parse(cls, s):
        ...
        while count < length:
            ...
            current_byte = int.from_bytes(current)
                ...
                if len(stack) == 2 and stack[0] == b'' and len(stack[1]) == 32:
                    ...
                    if s256 != sha256(witness_script):  # <5>
                        print('bad sha256 {} vs {}'.format
                            (s256.hex(), sha256(witness_script).hex())) # type: ignore
                        return False
